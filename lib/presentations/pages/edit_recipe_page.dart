...
class EditRecipePage extends StatefulWidget {
  static const String routeName = 'edit recipe page';
  EditRecipePage(
      {Key? key,
      required this.des,
      required this.image,
...
class _EditRecipePageState extends State<EditRecipePage> {
  ...
  List<TextEditingController> stp = [];
  List<TextEditingController> ing = [];
  String cata = 'others';
  ...
  @override
  void dispose() {
    for (TextEditingController t in ing) {
      t.dispose();
    }
    for (TextEditingController t in stp) {
      t.dispose();
    }
    super.dispose();
  }
                            ...
                            itemBuilder: (context, index) {
                              if (snapshot.data!.docs[index]['email'] ==
                                ...
                                return InkWell(
                                  ...
                                  //       cook_time: time.text,
                                  //       ingredient:
                                  //           widget.ingr.map((e) => e.text).toList(),
                                  //       steps:
                                  //           widget.step.map((e) => e.text).toList());
            ...
            children: [
              ...
              Container(
                child: ListView.builder(
                  ...
                  itemCount: widget.ingr.length,
                  itemBuilder: (context, index) {
                    print(widget.ingr.length);
                    return InkWell(
                      onTap: () {
                        _showDialog(context,
                            title: widget.ingr[index], email: 'email');
                      },
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Row(
              ...
              Container(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    print(widget.step.length);
                    return InkWell(
                      onTap: () {
                        _showDialog(context,
                            title: widget.step[index], email: 'email');
                      },
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Row(
...
void _showDialog(
  ...
  TextEditingController tit = TextEditingController(text: title.toString());
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        title: Text(
          "Do you want to edit your Ingredients ? ",
